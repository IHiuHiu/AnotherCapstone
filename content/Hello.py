...
email, authentication_status, username = Authenticator.login(fields= {'Form name':'Login', 'Username':'Username', 'Password':'Password', 'Login':'Enter to Submit'}) #':green[Login]', 'main'
